...
public class DrillingUnit3D extends ProcessingUnit3D {
    ...
    protected BranchGroup createStructure() {
        ...
        Box drill = new Box( 1, 1, 1, AppearanceAttributes.getColorApp( AppearanceAttributes.getBodyColor() ) );
        ...
        Cylinder drillArm = new Cylinder( 0.1f, 2, AppearanceAttributes.getColorApp( AppearanceAttributes.getActuatorColor() ) );
        ...
        Box topDrillSensor = new Box( 0.25f, 0.25f, 0.25f,AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Box bottomDrillSensor = new Box( 0.25f, 0.25f, 0.25f,AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Cylinder drillMotor = new Cylinder( 0.5f, 1, AppearanceAttributes.getColorApp( AppearanceAttributes.getActuatorColor() ) );
        ...
        Box pushOutCylinder = new Box( 1, 1, 1, AppearanceAttributes.getColorApp( AppearanceAttributes.getBodyColor() ) );
        ...
        Cylinder pushOutArm = new Cylinder( 0.1f, 0.5f, AppearanceAttributes.getColorApp( AppearanceAttributes.getActuatorColor() ) );
        ...
        Box frontArmSensor = new Box( 0.25f, 0.25f, 0.25f,AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Box backArmSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
