...
public class RotaryDisk3D extends ConveyorUnit3D {
    ...
    protected BranchGroup createStructure() {
        ...
        Cylinder motor = new Cylinder( 1, 6, AppearanceAttributes.getColorApp("green") );
        ...
        Cylinder disk = new Cylinder( 8, 0.1f, null );
        ...
        Box workpiece1Sensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp("blue") );
        ...
        Box workpiece2Sensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp("blue") );
        ...
        Box workpiece3Sensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp("blue") );
