 ...
 * events.
 */
public class SphereCubeSwing3D extends JPanel implements ActionListener
{
 /*
...
protected Bounds createApplicationBounds()
 ...
 protected void removeShape( String name )
 {
  try
  {
   ...
   java.util.Enumeration enum1 = sceneBranchGroup.getAllChildren();
   int index = 0;
 ...
 */
 ...
 public static void main( String[] args )
 {
  ...
  //with the 3D view.
  SphereCubeSwing3D swingTest = new SphereCubeSwing3D();
