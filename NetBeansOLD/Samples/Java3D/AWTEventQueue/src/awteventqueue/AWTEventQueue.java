 ...
 */
public class AWTEventQueue extends JFrame implements ActionListener, WindowListener
{
        ...
        item.addActionListener( new ActionListener() 
                {
                    public void actionPerformed(ActionEvent e) 
                    {
                        ...
                        worker = null;
                        AWTEventQueue.this.setVisible(false);
                        AWTEventQueue.this.dispose();
                    }
                });
        menu.add(item);
    ...
    private static void createAndShowGUI() 
    {
        ...
        AWTEventQueue framework = new AWTEventQueue();
    }
