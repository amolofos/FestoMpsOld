...
public class SwivelArmWithSuctionCup extends ConveyorUnit3D {
    ...
    protected BranchGroup createStructure( ) {
        ...
        Box topBase = new Box( 1.5f, 0.1f, 0.25f, null );
        ...
        Cylinder motor = new Cylinder( 1, 1, AppearanceAttributes.getColorApp("green") );
        ...
        Cylinder arm = new Cylinder( 0.1f, 3 );
        ...
        Cylinder suctionCupHolder = new Cylinder( 0.1f, 1 );
        ...
        Cone suctionCup = new Cone( 0.2f, 0.6f );
        ...
        Box rightArmSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp("blue") );
        ...
        Box leftArmSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp("blue") );
        ...
        Box vacuumSwitch = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp("blue") );
