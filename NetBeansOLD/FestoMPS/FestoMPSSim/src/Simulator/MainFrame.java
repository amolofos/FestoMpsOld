...
public class MainFrame extends javax.swing.JFrame {
     ...
     * 
     */
    protected GuiBinderSim guiBinder = null;
    /**
     * 
     */
     ...
     * 
     */
    protected TestingStation tS = null;
    /**
     * 
     */
    protected ProcessingStation pS = null;
    /**
     * 
     */
    protected WarehousingStation wS = null;
    /**
     * 
     */
    ...
    private void initComponents() {
        ...
        javaP = new javax.swing.JPanel();
        jLabel9 = new javax.swing.JLabel();
        jSeparator6 = new javax.swing.JSeparator();
        jLabel10 = new javax.swing.JLabel();
        jreLocationButton = new javax.swing.JButton();
        jreLocationField = new javax.swing.JTextField();
        ...
        aboutLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Resources/120px-Upatras.jpg"))); // NOI18N
        ...
        jTextPane2.setText("Η εφαρμογή αναπτύχθηκε από τον Δημήτριο Ανδρέα Καφετζή κατά την εκπόνηση της διπλωματικής του εργασίας. Παραχωρείται χωρίς καμία εγγύηση καλής λειτουργίας μαζί με τον κώδικά της για περαιτέρω βελτίωση και τροποποιήσεις ανάλογα με τη χρήση.");
        ...
        javaP.setBorder(javax.swing.BorderFactory.createTitledBorder("Java Preferences"));
        javaP.setMinimumSize(new java.awt.Dimension(620, 420));
        javaP.setPreferredSize(new java.awt.Dimension(666, 344));

        jLabel9.setForeground(new java.awt.Color(255, 0, 0));
        jLabel9.setText("Java Runtime Environment");

        jLabel10.setText("JRE location path");

        jreLocationButton.setText("set location");
        jreLocationButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jreLocationButtonMouseClicked(evt);
            }
        });

        jreLocationField.setBackground(new java.awt.Color(240, 240, 240));
        jreLocationField.setBorder(null);

        javax.swing.GroupLayout javaPLayout = new javax.swing.GroupLayout(javaP);
        javaP.setLayout(javaPLayout);
        javaPLayout.setHorizontalGroup(
            javaPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javaPLayout.createSequentialGroup()
                .addComponent(jLabel9)
                .addContainerGap(480, Short.MAX_VALUE))
            .addComponent(jSeparator6, javax.swing.GroupLayout.DEFAULT_SIZE, 608, Short.MAX_VALUE)
            .addGroup(javaPLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabel10)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jreLocationButton)
                .addGap(18, 18, 18)
                .addComponent(jreLocationField, javax.swing.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)
                .addContainerGap())
        );
        javaPLayout.setVerticalGroup(
            javaPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javaPLayout.createSequentialGroup()
                .addComponent(jLabel9)
                .addGap(7, 7, 7)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(javaPLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(jreLocationButton)
                    .addComponent(jreLocationField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(340, Short.MAX_VALUE))
        );

        javaP.setBounds(0, 0, 620, 420);
        jLayeredPane1.add(javaP, javax.swing.JLayeredPane.DEFAULT_LAYER);
        ...
        preferencesList.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Connections", "Appearance", "Java" };
        ...
        addRejectedWorkpiece_dS.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        ...
        addAcceptedWorkpiece_dS.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
    ...
    private void topMenuHelpAboutMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_topMenuHelpAboutMouseReleased
        aboutF.setLocationRelativeTo( this );
    ...
    private void addAcceptedWorkpiece_dSMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addAcceptedWorkpiece_dSMouseClicked
        guiBinder.receiveCmd( "dS", "dS.stack.workpiece.in" );
    ...
    private void topMenuEditPreferencesMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_topMenuEditPreferencesMouseReleased
        ...
        sensorsIPField_dS.setText( FestoMPSSim.sensorsControllerIP[0] );
        sensorsPortField_dS.setText( String.valueOf( FestoMPSSim.ports[0][0] ) );
        actuatorsPortField_dS.setText( String.valueOf( FestoMPSSim.ports[0][1] ) );
        communicationPortField_dS.setText( String.valueOf( FestoMPSSim.ports[0][2] ) );
        
        sensorsIPField_tS.setText( FestoMPSSim.sensorsControllerIP[1] );
        sensorsPortField_tS.setText( String.valueOf( FestoMPSSim.ports[1][0] ) );
        actuatorsPortField_tS.setText( String.valueOf( FestoMPSSim.ports[1][1] ) );
        communicationPortField_tS.setText( String.valueOf( FestoMPSSim.ports[1][2] ) );
        
        sensorsIPField_pS.setText( FestoMPSSim.sensorsControllerIP[2] );
        sensorsPortField_pS.setText( String.valueOf( FestoMPSSim.ports[2][0] ) );
        actuatorsPortField_pS.setText( String.valueOf( FestoMPSSim.ports[2][1] ) );
        communicationPortField_pS.setText( String.valueOf( FestoMPSSim.ports[2][2] ) );
        
        sensorsIPField_wS.setText( FestoMPSSim.sensorsControllerIP[3] );
        sensorsPortField_wS.setText( String.valueOf( FestoMPSSim.ports[3][0] ) );
        actuatorsPortField_wS.setText( String.valueOf( FestoMPSSim.ports[3][1] ) );
        communicationPortField_wS.setText( String.valueOf( FestoMPSSim.ports[3][2] ) );
        ...
        jreLocationField.setText( FestoMPSSim.getJRELocationPath().toString() );
    ...
    private void preferencesFrameSaveMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_preferencesFrameSaveMouseReleased
        ...
        javaField[0] = jreLocationField.getText();
        
        if( FestoMPSSim.savePreferencesXML( sensorsIPField, portsField, colorsField, javaField ) != 1 )
            JOptionPane.showMessageDialog( preferencesFrame, "A problem occured when saving options to preferences.xml. Please refer to errorlog for details", "Saving preferences", JOptionPane.WARNING_MESSAGE );
    ...
    private void executionPAncestorResized(java.awt.event.HierarchyEvent evt) {//GEN-FIRST:event_executionPAncestorResized
        ...
        FestoMPSSim.resizeCanvas( this );
    }//GEN-LAST:event_executionPAncestorResized

    private void jreLocationButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jreLocationButtonMouseClicked
        
        
        JFileChooser pathChooser = new JFileChooser( FestoMPSSim.getJRELocationPath().toString() );
        pathChooser.setFileSelectionMode( JFileChooser.DIRECTORIES_ONLY );
        if( pathChooser.showOpenDialog( preferencesFrame ) == JFileChooser.APPROVE_OPTION )
            jreLocationField.setText( pathChooser.getSelectedFile().toString() );
    }//GEN-LAST:event_jreLocationButtonMouseClicked
    ...
    private javax.swing.JPanel javaP;
    private javax.swing.JButton jreLocationButton;
    private javax.swing.JTextField jreLocationField;
    ...
    private AbstractFormatterFactory getPortNumberFormat() {
        ...
        return new DefaultFormatterFactory( new PatternFormatter( PatternFormatter.getTcpUdpPortNumberRegexPattern() ) );
    }
    
    private AbstractFormatterFactory getIPNumberFormat() {
        
        return new DefaultFormatterFactory( new PatternFormatter( PatternFormatter.getIPNumberPattern() ) );
    }
     ...
     * @param tS
     */
    public void setTS( TestingStation tS ) {
     ...
     * @param pS
     */
    public void setPS( ProcessingStation pS ) {
     ...
     * @param wS
     */
    public void setWS( WarehousingStation wS ) {
        
        this.wS = wS;
    }
    
    public void setGuiBinder( GuiBinderSim guiBinder ) {
