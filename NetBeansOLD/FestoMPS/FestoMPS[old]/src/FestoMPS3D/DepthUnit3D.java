...
public class DepthUnit3D extends ProcessingUnit3D {
    ...
    protected BranchGroup createStructure() {
        ...
        Cylinder cylinder = new Cylinder( 0.5f, 2, AppearanceAttributes.getColorApp( "green" ) );
        ...
        Cylinder pushOutArm = new Cylinder( 0.1f, 2, AppearanceAttributes.getColorApp( "blue" ) );
        ...
        Box topCylinderSensor = new Box( 0.25f, 0.25f, 0.25f,AppearanceAttributes.getColorApp( "blue" ) );
