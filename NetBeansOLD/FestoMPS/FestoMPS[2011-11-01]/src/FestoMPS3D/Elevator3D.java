...
public class Elevator3D extends ConveyorUnit3D {
    ...
    protected BranchGroup createStructure( ) {
        ...
        Box elevatorColumn = new Box( 1, 8, 1, AppearanceAttributes.getColorApp( AppearanceAttributes.getStructureColor() ) );
        ...
        Box liftingCylinder = new Box( 0.5f, 0.5f, 0.5f, AppearanceAttributes.getColorApp( AppearanceAttributes.getActuatorColor() ) );
        ...
        Box topElevatorSensor = new Box( 0.25f, 0.25f, 0.25f,AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Box bottomElevatorSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Box elevatorPlate = new Box( 1f, 0.1f, 2f, AppearanceAttributes.getColorApp( AppearanceAttributes.getBodyColor()) );
        ...
        Box capacitiveSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Box reflectiveSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Box diffuseSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
        ...
        Box heightSensor = new Box( 0.25f, 0.25f, 0.25f, AppearanceAttributes.getColorApp( AppearanceAttributes.getSensorColor() ) );
